...
static void __init setup_node_to_cpumask_map(void)
{
	...
	for (node = 0; node < nr_possible_nodes; node++) {
		...
		cpumask_clearall_cpu(node_to_cpumask_map[node]);
	}
...
static int __init numa_alloc_distance(void)
{
	...
	size = nr_possible_nodes * nr_possible_nodes * sizeof(numa_distance[0]);
	...
	numa_distance_cnt = nr_possible_nodes;
...
static int __init numa_init(int (*init_func)(void))
{
	...
	if (nodemask_empty(&numa_nodes_parsed)) {
