...
void register_step_hook(struct step_hook *hook); /* TODO arm64/kernel/debug-monitor.c */
...
u8 debug_monitors_arch(void); /* TODO arm64/kernel/debug-monitor.c */
...
int aarch32_break_handler(struct pt_regs *regs); /* TODO arm64/kernel/debug-monitor.c */
