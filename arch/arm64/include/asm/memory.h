...
/*
 * VIRTUAL_OFFSET - the virtual address of the start of the linear map (top
 *		 (VA_BITS - 1))
...
#define VA_START		(UL(0xffffffffffffffff) - \
	(UL(1) << VA_BITS) + 1)
#define VIRTUAL_OFFSET		(UL(0xffffffffffffffff) - \
	(UL(1) << (VA_BITS - 1)) + 1)
#define KIMAGE_VADDR		(VA_START)
#define VMEMMAP_START		(VIRTUAL_OFFSET - VMEMMAP_SIZE)
...
#define __lm_to_phys(addr)	(((addr) & ~VIRTUAL_OFFSET) + PHYS_OFFSET)
